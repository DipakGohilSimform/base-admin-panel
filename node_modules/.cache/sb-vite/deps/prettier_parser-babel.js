...
`);
      ...
      function Xr(a, t) {
        ...
        if (e === "babel") {
          ...
          a = je(a, (n) => {
            var o;
            (o = n.leadingComments) != null && o.some(Is) && r.add(D(n));
          }), a = je(a, (n) => {
        ...
        if (a = je(a, (r) => {
          switch (r.type) {
            ...
            case "VariableDeclaration": {
              let n = Et(false, r.declarations, -1);
              n != null && n.init && i(r, n);
              break;
            }
          ...
          let r = Et(false, a.comments, -1);
          for (let n = a.comments.length - 2; n >= 0; n--) {
            let o = a.comments[n];
            B(o) === D(r) && be(o) && be(r) && It(o) && It(r) && (a.comments.splice(n + 1, 1), o.value += "*//*" + r.value, o.range = [D(o), B(r)]), r = o;
          }
        }
