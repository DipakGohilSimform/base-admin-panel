...
`)}
            `.trim(),{borderStyle:"round",padding:1,borderColor:"#F1618C"})),process.exit(1)),choices.length===1?[selectedTemplate]=choices:(logger28.info((0,import_boxen4.default)(import_ts_dedent37.dedent`
...
`)),logger31.info();let finalMessages=diagnosticMessages.filter(Boolean);finalMessages.length>0?(finalMessages.push(`You can find the full logs in ${import_chalk32.default.cyan(LOG_FILE_PATH2)}`),logger31.info((0,import_boxen5.default)(finalMessages.join(`
